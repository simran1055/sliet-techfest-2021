...
const { allStudentData, getUserId, getUserById, eventData, getUser, updateUser, notify, campusAmbassador, teamList, campusAmbassadorListAdmin, campusAmbassadorList, updateTeam, createTeam, removeTeamMember, acceptTeamLink, testMessage, enrollUserinWorkshop, enrollUserinEvent, studentRegIn, addCert } = require("../controllers/user")
...
// addCert
router.get('/user/add-certificate', addCert)
